...
//        String str9 = new String("yyy"+"uuu");
//
//        String str11 = "yyy";

        String string = new String("uuu");
        String sss = "uuu";

//        System.out.println("yyy str3==str1:::"+(str11==str9.intern()));
//        System.out.println("yyy "+(str11==str11.intern()));
        System.out.println("uuu "+(sss==string.intern()));

        String string22 = new String("xxxx");
        System.out.println("xxxxx "+(string22==string22.intern()));
